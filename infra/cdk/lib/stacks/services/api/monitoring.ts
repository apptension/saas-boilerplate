...
export class Monitoring extends Construct {
  ...
  new MetricFilter(this, 'HTTP2xxResponses', {
      ...
      filterPattern: FilterPattern.literal('[ip, id, user, timestamp, request, status_code=2*, size]'),
    ...
    new MetricFilter(this, 'HTTP4xxResponses', {
      logGroup: <ILogGroup> props.logGroup,
      filterPattern: FilterPattern.literal('[ip, id, user, timestamp, request, status_code=4*, size]'),
    ...
    new MetricFilter(this, 'HTTP5xxResponses', {
      logGroup: <ILogGroup> props.logGroup,
      filterPattern: FilterPattern.literal('[ip, id, user, timestamp, request, status_code=5*, size]'),
