/**
 * This is a stub of renderEmail.
 *
 * The real version of this script should be located in packages/webapp-libs/webapp-emails/build/email-renderer/index.umd.js
 */
const renderEmail = (emailType, emailData) => {
  const errorMsg =
