...
urlpatterns = [
    ...
    path('tenant/<str:tenant_id>/connections/<str:connection_id>', views.SSOConnectionDetailView.as_view(), name='sso-connection-detail'),
    path('tenant/<str:tenant_id>/connections/<str:connection_id>/activate', views.SSOConnectionActivateView.as_view(), name='sso-connection-activate'),
    path('tenant/<str:tenant_id>/connections/<str:connection_id>/deactivate', views.SSOConnectionDeactivateView.as_view(), name='sso-connection-deactivate'),
    ...
    path('passkeys/authenticate/options', views.PasskeyAuthenticationOptionsView.as_view(), name='passkey-auth-options'),
    ...
    path('tenant/<str:tenant_id>/passkeys/<str:passkey_id>', views.TenantPasskeyListView.as_view(), name='tenant-passkey-delete'),
    
    # SCIM Token Management
    path('tenant/<str:tenant_id>/scim-tokens/', views.SCIMTokenListView.as_view(), name='scim-token-list'),
    path('tenant/<str:tenant_id>/scim-tokens/<str:token_id>', views.SCIMTokenDetailView.as_view(), name='scim-token-detail'),
