...
The payments functionality enables tenants to define and manage payment methods securely stored in their Stripe merchant account.
Tenant owners can add, edit, or remove payment methods, including multiple cards, to facilitate seamless transactions.
