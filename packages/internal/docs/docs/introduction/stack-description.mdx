...
|------------|---------|-------------|
| **React** | 18.3.x | Component-based UI library for building user interfaces |
...
| **Django** | 5.0.x | High-level Python web framework |
| **Graphene-Django** | 3.x | GraphQL integration for Django |
