...
description: Complete technology stack with versions
---
...
The versions listed below are the current defaults. Check `package.json` and `pyproject.toml` for the exact versions in your project.
:::
...
|------------|---------|-------------|
| **React** | 19.2.x | Component-based UI library for building user interfaces |
| **TypeScript** | 5.4.x | Static typing for better tooling and code quality |
| **Vite** | 6.x | Fast build tool with instant HMR |
| **Apollo Client** | 4.x | Comprehensive GraphQL client with state management |
| **React Router** | 7.x | Declarative routing for React applications |
| **Tailwind CSS** | 3.4.x | Utility-first CSS framework |
| **shadcn/ui** | Latest | Accessible components built with Radix UI |
| **Storybook** | 10.x | Development environment for UI components |

### Core Libraries

- **React**: A popular JavaScript library for building user interfaces, React 19 provides a component-based approach to
front-end development with improved performance, better server components support, and enhanced developer experience.
- **TypeScript**: TypeScript adds static typing to JavaScript, enabling better tooling, improved code quality, and
...
- **Apollo Client**: Apollo Client 4 is a comprehensive GraphQL client and state management library for JavaScript applications. It
seamlessly integrates with React and GraphQL, providing tools for data caching, real-time updates, error handling, and optimistic UI updates.
- **React Router**: React Router 7 provides declarative routing for React applications with improved performance, better TypeScript support, and enhanced data loading capabilities.
- **Tailwind CSS**: A utility-first CSS framework that provides low-level utility classes to build custom designs
directly in your markup, enabling rapid UI development with consistent styling.
- **shadcn/ui**: A collection of re-usable components built with Radix UI and Tailwind CSS. These accessible,
customizable components are centrally managed in the `webapp-core` package.
...
- **Storybook**: Storybook 10 is a development environment for UI components with improved performance, better Vite integration, and enhanced theming capabilities. It allows you to build and test individual
components in isolation, promoting a modular and reusable approach to UI development.
- **Vite**: Vite 6 is a fast build tool for modern JavaScript applications with improved performance, better ESM support, and enhanced developer experience. It provides instant server start-up and
...
| **Django** | 5.2.x | High-level Python web framework |
| **Django REST Framework** | 3.15.x | Powerful toolkit for building Web APIs |
| **Graphene-Django** | 3.2.x | GraphQL integration for Django |
| **Celery** | 5.4.x | Distributed task queue |
| **Sentry SDK** | 2.0.x | Error tracking and performance monitoring |
...
| Technology | Version | Description |
|------------|---------|-------------|
| **NX** | 19.x | Monorepo build system with improved caching and task execution |
...
- **[Architecture](/introduction/architecture)** — How the stack components work together
- **[Quick Start](/getting-started)** — Get the stack running locally
- **[AWS Deployment](/aws)** — Deploy to production
- **[Coding Standards](/introduction/coding-standards)** — Code quality tools and conventions
