...
[environment docs](/v1/setup-aws/environment-stage) for more details.
...
:::info
You can also build and deploy apps from your local device. [Read more](/v1/guides/aws-manual-deploy)
:::
