...
This guide should be followed right after initializing an empty repository with SaaS Boilerplate project. If you'd like to start with an already existing project, please visit [Launch existing project](./run-existing-project).
...
```shell
npx @apptension/saas-boilerplate-cli init .
```
