...
In this guide, we will show you how to create a new React component in a web application package using SaaS Boilerplate.
...
Check the `webapp` [API reference](../../../api-reference/webapp/commands#run-plop-generator) for more information.
