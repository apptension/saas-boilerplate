...
SaaS Boilerplate's web application is using [React router](https://reactrouter.com/en/main) to enable client side
...
- [`nestedPath`](../../api-reference/webapp-core/utils#nestedpath) – helper function to define typed nested route
config
...
- [`ValidRoutesProviders`](../../api-reference/webapp/components#validroutesproviders) – renders various language-dependant
providers.
...
- [`ValidRoutesProviders`](../../api-reference/webapp/components#validroutesproviders) – renders various language-dependant
providers.
- [`AuthRoute`](../../api-reference/webapp/components#authroute) – Component that only renders for authenticated user.
...
- [`ValidRoutesProviders`](../../api-reference/webapp/components#validroutesproviders) – renders various language-dependant
providers.
- [`AnonymousRoute`](../../api-reference/webapp/components#anonymousroute) – renders route only for anonymous users
