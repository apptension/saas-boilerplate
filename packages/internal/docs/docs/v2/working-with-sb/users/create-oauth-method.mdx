...
The SaaS Boilerplate uses the [python-social-auth](https://python-social-auth.readthedocs.io/en/latest/) package to provide social login functionality with Django.
