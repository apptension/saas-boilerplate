...
To add a new user role to the SaaS Boilerplate, you need to add it to the `CommonGroups` class and create a Django migration to insert the group into the database.
