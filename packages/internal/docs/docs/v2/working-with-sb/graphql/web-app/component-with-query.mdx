...
The code above uses some internal SaaS Boilerplate helpers that aid in writing Storybooks and tests efficiently:
...
- [`withProviders`](../../../api-reference/webapp/utils#withproviders): This is a helper that wraps a Storybook story with the necessary providers (including `MockedProvider`).
