...
To find more about using `chamber` in the project check [How to configure environment variables on AWS?](../../working-with-sb/infrastructure/env-variables) guide.
...
[here](../../working-with-sb/infrastructure/env-variables#using-the-cli-tool).
