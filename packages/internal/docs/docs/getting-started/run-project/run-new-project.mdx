...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock>npm init saas-boilerplate PATH</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock>pnpm create saas-boilerplate PATH</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock>yarn create saas-boilerplate PATH</CodeBlock>
  </TabItem>
</Tabs>
...
Start by copying and renaming shared default envs.

```bash
(from root level)
cp .env.shared .env
cd packages/backend && cp .env.shared .env
```
...
You can generate secret and hash using following commands:
