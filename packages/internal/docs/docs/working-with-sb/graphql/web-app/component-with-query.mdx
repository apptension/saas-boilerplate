...
```tsx title="packages/webapp/src/shared/components/exampleComponent/exampleComponent.graphql.ts" showLineNumbers
...
// highlight-next-line
import { todoQuery } from './exampleComponent.graphql';
...
describe('ExampleComponent: Component', () => {
  ...
  // highlight-start
  it('should render todo name', async () => {
    const todo = { id: 1, name: 'Todo' };
    ...
    // First, the loading state should be displayed
    expect(await screen.findByText(loadingText)).toBeInTheDocument();

    // After data loads, the todo name should be rendered
...
// highlight-next-line
import { todosQuery } from './exampleComponent.graphql';
  ...
  decorators: [
    withProviders({
      apolloMocks: append(
        ...
        'todos',
        'TodoType',  // This is the GraphQL typename, not the query name
        {
          data: todos
        })
        // highlight-end
...
```tsx title="packages/webapp/src/shared/components/exampleComponent/__tests__/exampleComponent.component.spec.tsx"
// highlight-next-line
import { composeMockedListQueryResult } from '@sb/webapp-api-client/tests/utils';
import { screen } from '@testing-library/react';
import { append } from 'ramda';
...
describe('ExampleComponent: Component', () => {
  ...
  it('should render list', async () => {
    ...
    render(<ExampleComponent />, {
      apolloMocks: append(
        // highlight-next-line
        composeMockedListQueryResult(todosQuery, 'todos', 'TodoType', { data: todos })
      ),
    });
    ...
    // After data loads, the first todo name should be rendered
