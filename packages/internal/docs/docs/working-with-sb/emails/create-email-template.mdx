...
Use Mailcatcher to preview emails during development:

1. Emails are automatically caught at `http://localhost:1080`
2. Use Storybook to preview and send test emails via the browser

See [Mailcatcher guide](/working-with-sb/dev-tools/mailcatcher) for more details.
...
| Guide | Description |
|-------|-------------|
| [Send Email](/working-with-sb/emails/send-email) | Trigger your email template from backend |
| [Mailcatcher](/working-with-sb/dev-tools/mailcatcher) | Preview emails locally |
| [Plop Generator](/working-with-sb/dev-tools/plop) | Generate email boilerplate |
