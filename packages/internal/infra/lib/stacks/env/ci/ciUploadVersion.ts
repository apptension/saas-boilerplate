...
export class UploadVersionCiConfig extends ServiceCiConfig {
  ...
  private createDeployAction(
    ...
    return new codebuildActions.CodeBuildAction(<codebuildActions.CodeBuildActionProps>{
      ...actionProps,
    ...
    const project = new codebuild.Project(this, 'UploadVersionDeployProject', {
      ...
      buildSpec: codebuild.BuildSpec.fromObject({
        ...
        phases: {
          ...
          build: { commands: ['nx run tools:upload-version migrations,api,workers,webapp'] },
        },
        cache: {
