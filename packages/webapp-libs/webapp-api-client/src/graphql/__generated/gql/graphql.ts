...
export type CrudDemoItemListRowActionsTestQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type CrudDemoItemListRowActionsTestQueryQuery = { __typename?: 'Query', item?: { __typename?: 'CrudDemoItemType', id: string, name: string } | null };
...
export const CrudDemoItemListRowActionsTestQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"crudDemoItemListRowActionsTestQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"item"},"name":{"kind":"Name","value":"crudDemoItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"StringValue","value":"test-id","block":false}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<CrudDemoItemListRowActionsTestQueryQuery, CrudDemoItemListRowActionsTestQueryQueryVariables>;
